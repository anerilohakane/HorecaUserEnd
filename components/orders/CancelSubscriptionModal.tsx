...
const CancelSubscriptionModal: React.FC<CancelSubscriptionModalProps> = ({ isOpen, onClose, onSubmit, subscriptionId }) => {
            ...
            <div className="bg-white rounded-2xl w-full max-w-lg shadow-2xl animate-in fade-in zoom-in duration-200">
                ...
                <div className="flex items-center justify-between p-6 border-b border-gray-100">
                    <div>
                        ...
                        <p className="text-sm text-gray-500 mt-1">ID: #{subscriptionId?.slice(-8).toUpperCase()}</p>
                    </div>
